# REFERENCE: https://elliott-king.github.io/2020/09/s3-heroku-rails/
...
class Api::V1::DirectUploadController < ApplicationController
  ...
  def create_blob(blob_args)
    ...
    avatar_id = SecureRandom.uuid # the name of the file will just be a UUID
    blob.update_attribute(:key, "uploads/#{avatar_id}") # will put it in the uploads folder
    blob
  end
